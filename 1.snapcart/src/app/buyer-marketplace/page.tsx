    ...
    return (
        <div className="min-h-screen bg-zinc-50">
            ...
            <div className="pb-20 pt-[140px] w-[95%] md:w-[90%] mx-auto space-y-12">
                ...
                {/* Header & Stats */}
                <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6 md:gap-8 bg-white p-6 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-xl shadow-zinc-900/5 border border-zinc-100">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="bg-zinc-50 px-6 md:px-8 py-4 md:py-6 rounded-3xl border border-zinc-100 flex-1 sm:min-w-[160px]">
                            ...
                            <div className="text-xl md:text-2xl font-black text-zinc-900">124+</div>
                        </div>
                        <div className="bg-blue-600 px-6 md:px-8 py-4 md:py-6 rounded-3xl shadow-lg shadow-blue-600/20 text-white flex-1 sm:min-w-[160px]">
                            ...
                            <div className="text-xl md:text-2xl font-black">2.4k Tons</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-white p-10 rounded-[3rem] border border-zinc-100 shadow-xl shadow-zinc-900/5 space-y-8">
                            <h3 className="text-2xl font-black text-zinc-900 tracking-tight">Market Intelligence</h3>
                            <div className="space-y-4">
                                <div className="p-6 bg-zinc-50 rounded-3xl group hover:bg-zinc-100 transition-colors cursor-pointer border border-zinc-100">
                                    <div className="flex items-center justify-between mb-2">
