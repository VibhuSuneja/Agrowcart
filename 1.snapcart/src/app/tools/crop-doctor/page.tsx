...
import { Upload, Loader2, Sprout, AlertCircle, CheckCircle } from 'lucide-react';
                    ...
                    {!preview ? (
                        ...
                        <div className="relative rounded-2xl overflow-hidden mb-6 group">
                            ...
                            <button
                                ...
                                className="absolute top-4 right-4 bg-white/90 p-2 rounded-full text-red-500 hover:text-red-700 shadow-sm"
                            >
                                ✕
                            </button>
                        </div>
