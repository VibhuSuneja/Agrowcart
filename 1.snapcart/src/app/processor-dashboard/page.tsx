...
function ProcessorDashboard() {
    ...
    const [newCrop, setNewCrop] = useState<{
        ...
        name: '', quantity: '', price: '', category: 'Value-Added', unit: 'kg', farmId: 'PROC-' + Math.floor(Math.random() * 9000 + 1000), harvestDate: new Date().toISOString().split('T')[0], image: null, imagePreview: null
    })
