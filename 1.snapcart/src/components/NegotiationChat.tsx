    ...
    return (
        ...
        >
            ...
            >
                ...
                {/* Header */}
                <div className="bg-zinc-900 p-4 md:p-8 text-white flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                        ...
                        <button onClick={onClose} className="p-2.5 md:p-3 bg-white/10 hover:bg-white/20 rounded-xl transition-colors">
                            <X size={16} />
                        </button>
                    </div>
                </div>
