    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const startMedia = async ()=>{
            try {
                ...
                peerInstance = peer;
                peer.on('signal', (data)=>{
                    console.log(`📡 VoiceCall: [${isInitiator ? "Initiator" : "Receiver"}] Signal Generated`, data.type);
                    if (isInitiator) {
                ...
                peer.on('stream', (remoteStream)=>{
                    console.log("🔊 VoiceCall: Remote Audio Stream Received (Tracks:", remoteStream.getAudioTracks().length, ")");
                ...
                const handleCallAccepted = (signal)=>{
                    console.log("⚡ VoiceCall: Call Accepted! Finalizing Handshake");
                    setCallAccepted(true);
                ...
                if (isInitiator) {
                    ...
                    console.log("📥 VoiceCall: Mounting with existing signal");
...
function NegotiationChat({ productId, buyerId, farmerId, farmerName, buyerName = "Buyer", currentUserRole = "buyer", onClose, initialIncomingCall }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (!socket) return;
        console.log("NegotiationChat: Initializing Handlers", socket.id);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        if (socket && rooms.length > 0) {
            rooms.forEach((room)=>{
                ...
                console.log(`📡 Farmer Hub: Monitoring Room [${room._id}]`);
            });
        }
        return ()=>clearInterval(interval);
    }, [
        rooms.length
    ]); // Trigger join when new rooms are discovered
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d1db1bde._.js.map