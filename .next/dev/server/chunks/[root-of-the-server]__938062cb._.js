...
"[project]/src/app/api/ai/crop-analysis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    Do not use markdown.`;
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gemini$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["model"].generateContent([
                prompt,
                {
                    inlineData: {
                        data: base64Data,
            ...
            const mockAnalysis = {
                ...
                issues: Math.random() > 0.5 ? [] : [
                    "Minor discoloration detected",
                    "Recommend quality check"
                ]
            };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__938062cb._.js.map