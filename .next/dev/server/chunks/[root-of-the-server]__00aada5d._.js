...
"[project]/src/models/discussion.model.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const discussionSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    userId: {
        type: __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema.Types.ObjectId,
        ref: "User",
        required: true
...
const Discussion = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Discussion || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Discussion", discussionSchema);
const __TURBOPACK__default__export__ = Discussion;
}),
...
"[project]/src/app/api/community/discussions/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$discussion$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/discussion.model.ts [app-route] (ecmascript)");
...
async function GET(req, { params }) {
    try {
        ...
        const discussion = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$discussion$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(id);
        if (!discussion) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: "Not found"
        }, {
            status: 404
        });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(discussion, {
            status: 200
        });
    } catch (error) {
...
async function PATCH(req, { params }) {
    try {
        ...
        if (hasLiked) {
            discussion.likedBy = discussion.likedBy.filter((uid)=>uid !== userId);
            discussion.likes -= 1;
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__00aada5d._.js.map