...
"[project]/src/app/api/chat/farmer-rooms/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const rooms = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$message$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    roomId: {
                        $regex: `^negotiation:${farmerId}:`
                    }
                }
            },
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__459dd4b2._.js.map