...
"[project]/src/app/api/recipes/[id]/like/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    try {
        ...
        const currentLikedBy = (recipe.likedBy || []).map((uid)=>String(uid));
        ...
        if (hasLiked) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$recipe$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].updateOne({
                _id: id
            }, {
                $set: {
                    likedBy: newLikedBy,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__734a0aa8._.js.map