                    ...
                    try {
                        ...
                        if (isInitiator) {
                            socket.on('call-accepted', {
                                "VoiceCall.useEffect.startMedia": (signal)=>{
...
_s(VoiceCall, "78/N4zYinHHZMHdkBP2nL41xXZc=");
_c = VoiceCall;
var _c;
...
_s(NegotiationChat, "MymdGxOe0K9DI1RXiyCXWzFRfCc=");
_c = NegotiationChat;
var _c;
...
function GlobalCallListener({ userId, role }) {
    ...
    const socket = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$socket$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSocket"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GlobalCallListener.useEffect": ()=>{
            if (!socket || !userId) return;
            const onConnect = {
                "GlobalCallListener.useEffect.onConnect": ()=>{
                    console.log("Global Listener: Socket Connected/Re-joining personal room:", userId);
                    socket.emit("join-room", `user:${userId}`);
                }
            }["GlobalCallListener.useEffect.onConnect"];
            const handleIncomingCall = {
                "GlobalCallListener.useEffect.handleIncomingCall": (data)=>{
                    console.log("Global Call Listener: Call Received", data);
                    setIncomingCall(data);
                }
            }["GlobalCallListener.useEffect.handleIncomingCall"];
            const handleNewMessage = {
                "GlobalCallListener.useEffect.handleNewMessage": (data)=>{
                    console.log("Global Alert: New Message", data);
                    // Show a premium toast if the message is from someone else
                    if (data.senderId !== userId) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success(`New Message: ${data.text.slice(0, 30)}${data.text.length > 30 ? '...' : ''}`, {
                            icon: '💬',
                            duration: 4000
                        });
                    }
                }
            }["GlobalCallListener.useEffect.handleNewMessage"];
...
_s(GlobalCallListener, "Xutw2GbH1skdOVsZUMl8eBazt9E=");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__865aafb3._.js.map