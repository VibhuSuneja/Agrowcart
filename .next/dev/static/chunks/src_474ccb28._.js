...
function DeliveryBoyDashboard({ earning }) {
    ...
    const handleAccept = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/delivery/assignment/${id}/accept-assignment`);
    ...
    const handleReject = async (id)=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/api/delivery/assignment/${id}/reject-assignment`);
...
_s(ProductItemCard, "o/i9H9MvE9r5j+1rpp0nGRLpR6w=", false, function() {
    return [
...
//# sourceMappingURL=src_474ccb28._.js.map