        ...
        <div className="min-h-screen bg-zinc-50">
            ...
            {isAskModalOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    ...
                    >
                        <h2 className="text-2xl font-black text-zinc-900 mb-6">Ask the Community</h2>
                        <form onSubmit={handleAskQuestion} className="space-y-4">
                            <div>
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">Question Title</label>
                                <input
                                    value={newTitle}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">Details</label>
                                <textarea
                                    value={newBody}
                            ...
                            <div>
                                <label className="block text-xs font-bold text-zinc-500 uppercase tracking-wider mb-2">Tags (comma separated)</label>
                                <input
                                    value={newTags}
