            ...
            <div className="pt-32 pb-20 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1 space-y-8">
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                        <div>
                            <h1 className="text-4xl font-black text-zinc-900 dark:text-white mb-2 tracking-tighter leading-none">Account <span className="text-emerald-600">Settings.</span></h1>
                            <p className="text-zinc-500 font-medium text-lg italic">"Your digital identity in the AgrowCart ecosystem."</p>
                        </div>
                        {!isEditing && (
                            <button
