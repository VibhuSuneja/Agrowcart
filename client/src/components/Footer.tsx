      ...
      <div className='w-[90%] md:w-[80%] mx-auto py-16 grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10'>
        ...
        <div>
          ...
          <ul className='space-y-3 text-zinc-400 text-sm'>
            ...
            <li><Link href={"/marketplace"} className='hover:text-green-400 transition-colors flex items-center gap-2'><span className="h-1 w-1 bg-green-500 rounded-full"></span>Marketplace</Link></li>
            ...
            <li><Link href={"/documentation"} className='hover:text-green-400 transition-colors flex items-center gap-2'><span className="h-1 w-1 bg-green-500 rounded-full"></span>Documentation</Link></li>
            <li><Link href={"/tools/ai-insights"} className='hover:text-green-400 transition-colors flex items-center gap-2'><span className="h-1 w-1 bg-green-500 rounded-full"></span>AI Insights</Link></li>
          </ul>
        </div>
