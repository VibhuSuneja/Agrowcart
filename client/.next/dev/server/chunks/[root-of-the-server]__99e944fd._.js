...
"[project]/src/app/api/ai/market-insight/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!session) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Unauthorized. Please login to get insights."
            }, {
                status: 401
            });
        }
        ...
        const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$ai$2d$cache$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            key: cacheKey
        });
        if (cached && cached.expiry > new Date()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(JSON.parse(cached.response), {
                status: 200
            });
        }
    ...
    Do not use markdown.`;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(fallbackInsight, {
            status: 200
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99e944fd._.js.map