...
"[project]/src/app/api/ai/millet-price/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    Do not use markdown formatting.`;
        ...
        if (existingCache && existingCache.expiry > new Date()) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(JSON.parse(existingCache.response), {
                status: 200,
                headers: {
                    'X-Cache': 'HIT'
                }
        ...
        try {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(mockPrediction, {
                status: 200
            });
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fca1a25d._.js.map