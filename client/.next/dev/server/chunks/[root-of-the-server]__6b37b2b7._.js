...
"[project]/src/app/api/community/discussions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
        const discussions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$discussion$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).sort({
            createdAt: -1
        }).limit(50); // Pagination can be added later
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(discussions, {
            status: 200
        });
    } catch (error) {
...
async function POST(req) {
    try {
        ...
        const discussion = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$discussion$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            ...body,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b37b2b7._.js.map