...
"[project]/src/models/message.model.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Message = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.NegotiationMessage || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("NegotiationMessage", messageSchema);
const __TURBOPACK__default__export__ = Message;
}),
"[project]/src/app/api/chat/send/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$message$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/message.model.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        if (!participantIds.includes(session.user.id)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: "Access Denied: You are not a participant in this negotiation."
            }, {
                status: 403
            });
        }
        // Create and save message
        const newMessage = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$message$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            roomId,
            text,
            senderId,
            time
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e2ca924d._.js.map