...
"[project]/src/app/api/user/my-orders/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const orders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$order$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
            user: session?.user?.id
        }).populate("user assignedDeliveryBoy").sort({
            createdAt: -1
        });
        if (!orders) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__018bac2d._.js.map