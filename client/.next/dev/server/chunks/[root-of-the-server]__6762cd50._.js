...
"[project]/src/models/user.model.ts [middleware] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$user$2e$model$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/user.model.ts [middleware] (ecmascript)");
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$auth$2f$core$2f$providers$2f$credentials$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials, request) {
                ...
                const user = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$user$2e$model$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"].findOne({
                    email
                });
                if (!user) {
                    throw new Error("user does not exist");
                }
                const isMatch = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$middleware$5d$__$28$ecmascript$29$__["default"].compare(password, user.password);
                if (!isMatch) {
    ...
    callbacks: {
        ...
        async signIn ({ user, account }) {
            ...
            if (account?.provider == "google") {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"])();
                let dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$user$2e$model$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"].findOne({
                    email: user.email
                });
                if (!dbUser) {
                    dbUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$user$2e$model$2e$ts__$5b$middleware$5d$__$28$ecmascript$29$__["default"].create({
                        name: user.name,
                        email: user.email,
                        image: user.image
                    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6762cd50._.js.map