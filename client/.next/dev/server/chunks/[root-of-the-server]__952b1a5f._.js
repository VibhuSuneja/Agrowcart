...
const __TURBOPACK__default__export__ = uploadOnCloudinary;
}),
"[project]/src/app/api/farmer/add-product/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const fssaiLicense = formData.get("fssaiLicense");
        const originState = formData.get("originState") || "Haryana";
        ...
        if (imageFile) {
            const uploadedUrl = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(imageFile);
            if (uploadedUrl) {
                imageUrl = uploadedUrl;
            }
        }
        // Create product
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$product$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__952b1a5f._.js.map