...
async function GET() {
    try {
        ...
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$product$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({}).populate("owner", "name role").sort({
            createdAt: -1
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2c189b2._.js.map