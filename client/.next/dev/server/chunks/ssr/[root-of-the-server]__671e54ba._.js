...
function NegotiationChat({ productId, buyerId, farmerId, farmerName, buyerName = "Buyer", currentUserRole = "buyer", onClose, initialIncomingCall }) {
    ...
    // ... (rest should be preserved by tool if possible, but I will provide a clean block)
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        if (initialIncomingCall) {
            console.log("⚡ NegotiationChat: Auto-bridging incoming audio signal to VoiceCall mounting...");
            setIncomingSignal(initialIncomingCall);
            setIsCalling(true);
            setReceivingCall(false); // Clean up receiving UI as we are now in 'Calling' mode
        }
    }, [
        initialIncomingCall
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__671e54ba._.js.map