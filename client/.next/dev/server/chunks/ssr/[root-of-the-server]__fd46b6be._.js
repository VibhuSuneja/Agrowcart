...
function GlobalCallListener({ userId, role }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        // Join user's personal notification room (optional) or just listen to room logic
        // For AgrowCart, calls are room-based (negotiation:F:B).
        // Since we don't know the roomIds until they are created, 
        // we should ideally have a user-specific signaling channel.
        // REFINED ARCHITECTURE: Users join a room named after their own ID to receive 'incoming-call' alerts globally.
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fd46b6be._.js.map